...
class SyncFrame(ctk.CTkFrame):
    ...
    def set_sync_ui_parts(self):
        ...
        self.recording_lb = ctk.CTkLabel(self,width=75,height=20,font=("Cosmic Sans MS", 18, "normal"),text="Sync Stages")
        ...
        self.sync_switch_bt = ctk.CTkSwitch(self.f3a,text="Sync MIPOS & KINESIS",command=self.synchronize_kinesis_mipos)
        ...
        self.hyst_switch_bt = ctk.CTkSwitch(self.f3a,text="Hystersis compensation",command=self.init_hysteresis_compensation)
        ...
        self.refindex_lb = ctk.CTkLabel(self.f3a,width=50,height=20,text="Refractive Index")

        self.refindex_lb.grid(row=2,column=0,padx=(5, 5),pady=(5, 5))

        self.refractiveindex_tf = ctk.CTkEntry(self.f3a,width=50,height=20,justify="center")
        ...
        self.move_bt_p1 = ctk.CTkButton(self.f3a,width=75,height=20,text="+1 µm",command=lambda: self.sync_move(-0.001, -1))

        self.move_bt_p1.grid(row=3,column=0,padx=(5, 5),pady=(5, 5))

        self.move_bt_p1.configure(state="disabled")

        self.move_bt_m1 = ctk.CTkButton(self.f3a,width=75,height=20,text="-1 µm",command=lambda: self.sync_move(0.001, 1))

        self.move_bt_m1.grid(row=3,column=1,padx=(5, 5),pady=(5, 5))

        self.move_bt_m1.configure(state="disabled")

        self.move_bt_p10 = ctk.CTkButton(self.f3a,width=75,height=20,text="+10 µm",command=lambda: self.sync_move(-0.01, -10))

        self.move_bt_p10.grid(row=4,column=0,padx=(5, 5),pady=(5, 5))

        self.move_bt_p10.configure(state="disabled")

        self.move_bt_m10 = ctk.CTkButton(self.f3a,width=75,height=20,text="-10 µm",command=lambda: self.sync_move(0.01, 10))
        ...
        self.syncfactor_lb = ctk.CTkLabel(self.f3a,width=50,height=20,text="Syncfaktor")

        self.syncfactor_lb.grid(row=5,column=0,padx=(5, 5),pady=(5, 5))

        self.syncfactor_tf = ctk.CTkEntry(self.f3a,width=50,height=20,justify="center")
